...
import { normalizeUrl, matchesPattern } from '@/lib/url-pattern';
describe('patternToRegex', () => {
    ...
    it('wildcard inside host', () => {
        expect(matchesPattern('myapp-*-myorg.vercel.app', 'https://myapp-feat-login-myorg.vercel.app/products')).toBe(true);
    });
